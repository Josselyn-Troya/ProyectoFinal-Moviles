...
public class PostDetailActivity extends AppCompatActivity {
    ...
    private void goToShowProfile() {
        if (!mIdUser.equals("")) {
            ...
            Toast.makeText(this, "El usuario aun no se carga", Toast.LENGTH_SHORT).show();
        }
    }
            ...
            public void onSuccess(DocumentSnapshot documentSnapshot) {
                if (documentSnapshot.exists()) {
                    ...
                    if (documentSnapshot.contains("category")) {
                        ...
                        if (category.equals("Juegos")) {
                            mImageViewCategory.setImageResource(R.drawable.juego);
                        }
                        else if (category.equals("Comida")) {
                            mImageViewCategory.setImageResource(R.drawable.comida);
                        }
                        else if (category.equals("Moda")) {
                            mImageViewCategory.setImageResource(R.drawable.moda);
                        }
                        else if (category.equals("Tecnología")) {
                            mImageViewCategory.setImageResource(R.drawable.tecnologia);
                        }
                        else if (category.equals("Otros")) {
                            mImageViewCategory.setImageResource(R.drawable.otros);
                        }
                        else if (category.equals("Deporte")) {
                            mImageViewCategory.setImageResource(R.drawable.deporte);
                        }
                        else if (category.equals("Animales")) {
                            mImageViewCategory.setImageResource(R.drawable.mascotas);
                        }
